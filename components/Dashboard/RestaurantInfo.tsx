...
import { fetchMenu, updateRestaurantName } from "@/lib/actions/menu.actions";
...
const RestaurantInfo = ({ menuId }: { menuId: string | null }) => {
    ...
    return (
        <div>
            ...
            <div className="flex items-center">{menuId && <AddCategoryButton menuId={menuId} setMenu={setMenu} />}</div>
            {menu &&
